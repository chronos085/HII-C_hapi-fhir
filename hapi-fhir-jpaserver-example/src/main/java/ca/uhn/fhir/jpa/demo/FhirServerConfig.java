...
import ca.uhn.fhir.jpa.demo.interceptor.PublicSecurityInterceptor;
import ca.uhn.fhir.jpa.demo.interceptor.BasicSecurityInterceptor;
...
//		extraProperties.put("hibernate.search.default.worker.execution", "async");
	...
	public StaticServerConfigurationService srv() {
		...
		srvCfg.setIssuer("http://192.168.0.9:8080/");
		srvCfg.setJwksUri("http://192.168.0.9:8080/jwk");
		srvCfg.setTokenEndpointUri("http://192.168.0.9:8080/token");
		srvCfg.setAuthorizationEndpointUri("http://192.168.0.9:8080/authorize");

		sr.getServers().put("http://192.168.0.9:8080/", srvCfg);
